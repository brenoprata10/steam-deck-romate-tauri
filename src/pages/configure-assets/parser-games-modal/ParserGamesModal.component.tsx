...
import GameCollection from '@/pages/configure-assets/parser-games-modal/game-collection/GameCollection.component'
...
import Radio from '@/uikit/radio/Radio.component'
